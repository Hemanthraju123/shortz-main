                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            child: Row(
                              children: [
                                ...
                                Image(
                                  ...
                                  height:
                                      widget.videoData!.isVerify == 1 ? 18 : 0,
                                  width:
                                      widget.videoData!.isVerify == 1 ? 18 : 0,
                                )
                              ],
                        ...
                        Visibility(
                          visible:
                              widget.videoData!.postDescription!.isNotEmpty,
                          child: Container(
                            margin: EdgeInsets.only(bottom: 5),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                            ...
                            MaterialPageRoute(
                              builder: (context) {
                                return ProfileScreen(
                                    type: 1,
                                    userId:
                                        widget.videoData?.userId.toString() ??
                                            '-1');
                              },
                            ),
                          );
                      ...
                      Visibility(
                        visible:
                            SessionManager.userId != widget.videoData!.userId,
                        child: InkWell(
                          onTap: () {
                      ...
                      InkWell(
                        ...
                        child: Image.asset(icComment,
                            height: 35, width: 35, color: ColorRes.white),
                      ),
                      Text(
                          NumberFormat.compact(locale: 'en')
                      ...
                      InkWell(
                        ...
                        child: Image.asset(icShare,
                            height: 32, width: 32, color: ColorRes.white),
                      ),
                      SizedBox(height: 15),
